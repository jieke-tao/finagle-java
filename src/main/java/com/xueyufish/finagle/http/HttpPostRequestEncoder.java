...
public class HttpPostRequestEncoder implements ChunkedInput {
    ...
    public void addBodyFileUpload(String name, File file, String contentType, boolean isText)
        ...
        if (contentType == null) {
            if (isText) {
                scontentType = com.xueyufish.finagle.http.HttpPostBodyUtil.DEFAULT_TEXT_CONTENT_TYPE;
            } else {
                scontentType = com.xueyufish.finagle.http.HttpPostBodyUtil.DEFAULT_BINARY_CONTENT_TYPE;
            }
        }
        if (!isText) {
            contentTransferEncoding = com.xueyufish.finagle.http.HttpPostBodyUtil.TransferEncodingMechanism.BINARY.value();
        }
    ...
    public void addBodyHttpData(InterfaceHttpData data)
        ...
        if (data instanceof Attribute) {
            ...
            Attribute attribute = (Attribute) data;
            internal.addValue(com.xueyufish.finagle.http.HttpPostBodyUtil.CONTENT_DISPOSITION + ": " +
                    com.xueyufish.finagle.http.HttpPostBodyUtil.FORM_DATA + "; " +
                    com.xueyufish.finagle.http.HttpPostBodyUtil.NAME + "=\"" + attribute.getName() + "\"\r\n");
            Charset localcharset = attribute.getCharset();
            if (localcharset != null) {
                // Content-Type: charset=charset
                internal.addValue(HttpHeaders.Names.CONTENT_TYPE + ": " +
                        com.xueyufish.finagle.http.HttpPostBodyUtil.DEFAULT_TEXT_CONTENT_TYPE + "; " +
            ...
            if (duringMixedMode) {
                ...
                if (encoderMode != EncoderMode.HTML5 && currentFileUpload != null &&
                    ...
                    replacement.append(com.xueyufish.finagle.http.HttpPostBodyUtil.CONTENT_DISPOSITION);
                    replacement.append(": ");
                    replacement.append(com.xueyufish.finagle.http.HttpPostBodyUtil.FORM_DATA);
                    replacement.append("; ");
                    replacement.append(com.xueyufish.finagle.http.HttpPostBodyUtil.NAME);
                    replacement.append("=\"");
                    ...
                    replacement.append(": ");
                    replacement.append(com.xueyufish.finagle.http.HttpPostBodyUtil.MULTIPART_MIXED);
                    replacement.append("; ");
                    ...
                    replacement.append(com.xueyufish.finagle.http.HttpPostBodyUtil.CONTENT_DISPOSITION);
                    replacement.append(": ");
                    replacement.append(com.xueyufish.finagle.http.HttpPostBodyUtil.ATTACHMENT);
                    replacement.append("; ");
                    replacement.append(com.xueyufish.finagle.http.HttpPostBodyUtil.FILENAME);
                    replacement.append("=\"");
            ...
            if (localMixed) {
                ...
                // Content-Disposition: attachment; filename="file1.txt"
                internal.addValue(com.xueyufish.finagle.http.HttpPostBodyUtil.CONTENT_DISPOSITION + ": " +
                        com.xueyufish.finagle.http.HttpPostBodyUtil.ATTACHMENT + "; " + com.xueyufish.finagle.http.HttpPostBodyUtil.FILENAME + "=\"" +
                ...
                // Content-Disposition: form-data; name="files"; filename="file1.txt"
                internal.addValue(com.xueyufish.finagle.http.HttpPostBodyUtil.CONTENT_DISPOSITION + ": " +
                        com.xueyufish.finagle.http.HttpPostBodyUtil.FORM_DATA + "; " + com.xueyufish.finagle.http.HttpPostBodyUtil.NAME + "=\"" +
                        fileUpload.getName() + "\"; " +
                        com.xueyufish.finagle.http.HttpPostBodyUtil.FILENAME + "=\"" +
                        fileUpload.getFilename() +
                        "\"\r\n");
            }
            ...
            if (contentTransferEncoding != null &&
                    contentTransferEncoding.equals(
                            com.xueyufish.finagle.http.HttpPostBodyUtil.TransferEncodingMechanism.BINARY.value())) {
    ...
    private ChannelBuffer fillChannelBuffer() {
        ...
        if (length > com.xueyufish.finagle.http.HttpPostBodyUtil.chunkSize) {
            ChannelBuffer slice =
                    currentBuffer.slice(currentBuffer.readerIndex(), com.xueyufish.finagle.http.HttpPostBodyUtil.chunkSize);
            currentBuffer.skipBytes(com.xueyufish.finagle.http.HttpPostBodyUtil.chunkSize);
            return slice;
        } else {
            // to continue
    ...
    private HttpChunk encodeNextChunkMultipart(int sizeleft) throws ErrorDataEncoderException {
        ...
        if (currentBuffer.readableBytes() < com.xueyufish.finagle.http.HttpPostBodyUtil.chunkSize) {
            currentData = null;
            return null;
        }
    ...
    public HttpChunk nextChunk() throws ErrorDataEncoderException {
        ...
        ChannelBuffer buffer;
        int size = com.xueyufish.finagle.http.HttpPostBodyUtil.chunkSize;
        ...
        if (currentData != null) {
            ...
            size = com.xueyufish.finagle.http.HttpPostBodyUtil.chunkSize - currentBuffer.readableBytes();
        }
        if (! iterator.hasNext()) {
            isLastChunk = true;
